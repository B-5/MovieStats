...
tmdb_api_key = 'ad02bd9750d54f08e377c69f4c7b2bab'
omdb_api_key = 'f72357da'
# s3_bucket_name = 'data-lake-compass-etl'

def extract(): # Testes locais. Comentar para S3.
#def lambda_handler(event, context):
    ...
    while page <= 6 and page <= total_pages: # Para testes. Apenas algumas páginas.
    ...
    # Testes locais - comentar para S3
